...
# Grove SH1107 OLED wiring in diagram.json:
...
# 32x32 bitmap fonts: ? = Hua, ! = Huo, # = Jie
FONT_82B1 = bytearray(
...
def draw_char(display, char, x, y, shrink=1, wrap_y=False, color=1):
...
def draw_static_scene(display):
    display.fill(0)
    draw_grid(display, center_x, center_y, oled_width, oled_height, grid_step)
